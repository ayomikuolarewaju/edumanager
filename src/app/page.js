...
const Home = () => {
  ...
  return (
    ...
    <div>
      <Reports value1='0'/>
      <Mains title='recent students' icon=<FaPlus/> actiony='Add Student' doAction={makeVisible} />

     {
      isVisible 
      ?
      <div className=' w-[1400px] h-[800px] justify-center items-center absolute top-0 left-[300px] content-center overflow-hidden bg-black/30 bg-blend-color z-40'>
