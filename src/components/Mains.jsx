...
const Main = ({title,actiony,doAction,icon,children}) => {
    ...
    return (
        <div className='px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 w-[1400px] h-[600px] absolute top-[300px] left-[300px]  flex justify-between items-start pt-[20px] m-[10px]  bg-white shadow-md shadow-black rounded-2xl'>
