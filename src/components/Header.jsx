...
function Header() {
  return (
    <div className='px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 w-[1400px] h-[80px] absolute top-0 left-[300px] flex justify-between items-center m-[10px]  bg-white shadow-md shadow-black rounded-2xl'>
